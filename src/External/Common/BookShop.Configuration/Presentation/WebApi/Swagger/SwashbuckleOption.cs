namespace BookShop.Configuration.Presentation.WebApi.Swagger;

/// summary
///     The SwashbuckleOption class is used to hold various jwt authentication configuration settings.
/// summary
