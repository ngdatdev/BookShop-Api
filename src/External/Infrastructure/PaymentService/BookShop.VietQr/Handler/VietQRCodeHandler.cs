...
namespace BookShop.VietQr.Handler;
...
public class VietQRCodeHandler : IQRCodeHandler
{
    ...
    public async Task<string> CreateUrlQRCode(QRCodeModel qRCodeModel)
    {
        ...
        var requestBody = new StringContent(
            Newtonsoft.Json.JsonConvert.SerializeObject(vietQRModel),
            Encoding.UTF8,
            "application/json"
        );
