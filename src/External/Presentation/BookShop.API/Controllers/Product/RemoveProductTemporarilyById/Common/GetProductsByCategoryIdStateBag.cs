...
namespace BookShop.API.Controllers.Product.RemoveProductTemporarilyByIdEndpoint.Common;

/// <summary>
///     Represents the get RemoveProductTemporarilyById state bag.
/// </summary>
internal sealed class RemoveProductTemporarilyByIdStateBag
{
