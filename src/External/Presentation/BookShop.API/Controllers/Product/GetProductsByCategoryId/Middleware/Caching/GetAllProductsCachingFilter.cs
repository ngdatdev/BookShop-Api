...
using BookShop.API.Controllers.Product.GetProductsByCategoryId.Common;
...
namespace BookShop.API.Controllers.Product.GetProductsByCategoryId.Middleware.Caching;
