...
namespace BookShop.API.Controllers.Product.GetAllProducts.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllProducts authorization.
/// </summary>
public class GetAllProductsAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllProductsAuthorizationFilter(
