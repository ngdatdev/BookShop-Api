...
namespace BookShop.API.Controllers.Product.GetAllTemporarilyRemovedProducts.Middleware.Authorization;
...
public class GetAllTemporarilyRemovedProductsAuthorizationFilter : IAsyncAuthorizationFilter
{
    ...
    public GetAllTemporarilyRemovedProductsAuthorizationFilter(
