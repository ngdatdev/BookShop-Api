...
namespace BookShop.API.Controllers.Address.RemoveAddressTemporarilyRemovedById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveAddressTemporarilyRemovedById authorization.
/// </summary>
public class RemoveAddressTemporarilyRemovedByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveAddressTemporarilyRemovedByIdAuthorizationFilter(
