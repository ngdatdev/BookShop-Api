...
namespace BookShop.API.Controllers.Address.RemoveAddressPermanentlyRemovedById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveAddressPermanentlyRemovedById authorization.
/// </summary>
public class RemoveAddressPermanentlyRemovedByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveAddressPermanentlyRemovedByIdAuthorizationFilter(
