...
namespace BookShop.API.Controllers.Address.RestoreAddressById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RestoreAddressById authorization.
/// </summary>
public class RestoreAddressByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RestoreAddressByIdAuthorizationFilter(
