...
namespace BookShop.API.Controllers.Address.UpdateAddressById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for UpdateAddressById authorization.
/// </summary>
public class UpdateAddressByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public UpdateAddressByIdAuthorizationFilter(
