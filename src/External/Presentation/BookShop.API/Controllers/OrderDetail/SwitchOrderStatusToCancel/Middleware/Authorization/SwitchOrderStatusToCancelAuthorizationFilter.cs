...
namespace BookShop.API.Controllers.OrderDetail.SwitchOrderStatusToCancel.Middleware.Authorization;

/// <summary>
///     Filter pipeline for SwitchOrderStatusToCancel authorization.
/// </summary>
public class SwitchOrderStatusToCancelAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public SwitchOrderStatusToCancelAuthorizationFilter(
