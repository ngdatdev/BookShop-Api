...
namespace BookShop.API.Controllers.OrderDetail.SwitchOrderStatusToCancel.Middleware.Caching;

/// <summary>
///     Filter pipeline for SwitchOrderStatusToCancel caching.
/// </summary>
public class SwitchOrderStatusToCancelCachingFilter : IAsyncActionFilter
{
    private readonly ICacheHandler _cacheHandler;

    public SwitchOrderStatusToCancelCachingFilter(ICacheHandler cacheHandler)
    {
    ...
    )
    {
        if (!context.HttpContext.Response.HasStarted)
        {
            ...
            {
                var httpResponse = (SwitchOrderStatusToCancelHttpResponse)result.Value;
