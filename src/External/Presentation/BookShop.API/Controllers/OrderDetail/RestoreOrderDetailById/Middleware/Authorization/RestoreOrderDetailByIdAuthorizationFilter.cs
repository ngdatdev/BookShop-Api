...
namespace BookShop.API.Controllers.OrderDetail.RestoreOrderDetailById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RestoreOrderDetailById authorization.
/// </summary>
public class RestoreOrderDetailByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RestoreOrderDetailByIdAuthorizationFilter(
