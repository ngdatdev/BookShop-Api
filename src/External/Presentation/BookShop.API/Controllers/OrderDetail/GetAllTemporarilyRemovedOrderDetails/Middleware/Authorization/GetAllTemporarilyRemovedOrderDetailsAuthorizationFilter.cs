...
namespace BookShop.API.Controllers.OrderDetail.GetAllTemporarilyRemovedOrderDetails.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllTemporarilyRemovedOrderDetails authorization.
/// </summary>
public class GetAllTemporarilyRemovedOrderDetailsAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllTemporarilyRemovedOrderDetailsAuthorizationFilter(
