...
namespace BookShop.API.Controllers.OrderDetail.RestoreOrderStatusToConfirm.Middleware.Caching;

/// <summary>
///     Filter pipeline for RestoreOrderStatusToConfirm caching.
/// </summary>
public class RestoreOrderStatusToConfirmCachingFilter : IAsyncActionFilter
{
    private readonly ICacheHandler _cacheHandler;

    public RestoreOrderStatusToConfirmCachingFilter(ICacheHandler cacheHandler)
    {
    ...
    )
    {
        if (!context.HttpContext.Response.HasStarted)
        {
            ...
            {
                var httpResponse = (RestoreOrderStatusToConfirmHttpResponse)result.Value;
