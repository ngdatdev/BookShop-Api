...
namespace BookShop.API.Controllers.OrderDetail.RestoreOrderStatusToConfirm.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RestoreOrderStatusToConfirm authorization.
/// </summary>
public class RestoreOrderStatusToConfirmAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RestoreOrderStatusToConfirmAuthorizationFilter(
