...
namespace BookShop.API.Controllers.OrderDetail.RemoveOrderDetailPermanentlyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveOrderDetailPermanentlyById authorization.
/// </summary>
public class RemoveOrderDetailPermanentlyByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveOrderDetailPermanentlyByIdAuthorizationFilter(
