...
namespace BookShop.API.Controllers.OrderDetail.SwitchOrderStatusToNext.Middleware.Authorization;

/// <summary>
///     Filter pipeline for SwitchOrderStatusToNext authorization.
/// </summary>
public class SwitchOrderStatusToNextAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public SwitchOrderStatusToNextAuthorizationFilter(
