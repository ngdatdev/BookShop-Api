...
namespace BookShop.API.Controllers.OrderDetail.RemoveOrderDetailTemporarilyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveOrderDetailTemporarilyById authorization.
/// </summary>
public class RemoveOrderDetailTemporarilyByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveOrderDetailTemporarilyByIdAuthorizationFilter(
