...
namespace BookShop.API.Controllers.User.GetAllUsersTemporarilyRemovedById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllUsersTemporarilyRemovedById authorization.
/// </summary>
public class GetAllUsersTemporarilyRemovedByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllUsersTemporarilyRemovedByIdAuthorizationFilter(
