...
namespace BookShop.API.Controllers.User.GetAllUsers.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllUsers authorization.
/// </summary>
public class GetAllUsersAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllUsersAuthorizationFilter(
