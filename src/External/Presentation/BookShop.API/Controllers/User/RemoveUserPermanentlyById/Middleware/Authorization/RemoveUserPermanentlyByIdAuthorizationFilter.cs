...
namespace BookShop.API.Controllers.User.RemoveUserPermanentlyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveUserPermanentlyById authorization.
/// </summary>
public class RemoveUserPermanentlyByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveUserPermanentlyByIdAuthorizationFilter(
