...
namespace BookShop.API.Controllers.User.RemoveUserTemporarilyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveUserTemporarilyById authorization.
/// </summary>
public class RemoveUserTemporarilyByIdByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveUserTemporarilyByIdByIdAuthorizationFilter(
