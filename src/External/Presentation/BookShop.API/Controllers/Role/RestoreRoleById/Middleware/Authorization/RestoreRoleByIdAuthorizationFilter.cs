...
namespace BookShop.API.Controllers.Role.RestoreRoleById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RestoreRoleById authorization.
/// </summary>
public class RestoreRoleByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RestoreRoleByIdAuthorizationFilter(
