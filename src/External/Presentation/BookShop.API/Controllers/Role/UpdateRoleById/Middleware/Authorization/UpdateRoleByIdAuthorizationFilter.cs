...
namespace BookShop.API.Controllers.Role.UpdateRoleById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for UpdateRoleById authorization.
/// </summary>
public class UpdateRoleByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public UpdateRoleByIdAuthorizationFilter(
