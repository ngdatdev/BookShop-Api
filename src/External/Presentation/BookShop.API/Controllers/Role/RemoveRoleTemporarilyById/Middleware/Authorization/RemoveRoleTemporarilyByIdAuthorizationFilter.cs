...
namespace BookShop.API.Controllers.Role.RemoveRoleTemporarilyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveRoleTemporarilyById authorization.
/// </summary>
public class RemoveRoleTemporarilyByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveRoleTemporarilyByIdAuthorizationFilter(
