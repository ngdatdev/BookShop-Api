...
namespace BookShop.API.Controllers.Role.CreateRole.Middleware.Authorization;

/// <summary>
///     Filter pipeline for CreateRole authorization.
/// </summary>
public class CreateRoleAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public CreateRoleAuthorizationFilter(
