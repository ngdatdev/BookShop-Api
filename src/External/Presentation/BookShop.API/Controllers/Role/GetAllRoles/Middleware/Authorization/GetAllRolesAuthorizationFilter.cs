...
namespace BookShop.API.Controllers.Role.GetAllRoles.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllRoles authorization.
/// </summary>
public class GetAllRolesAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllRolesAuthorizationFilter(
