...
namespace BookShop.API.Controllers.Role.RemoveRolePermanentlyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveRolePermanentlyById authorization.
/// </summary>
public class RemoveRolePermanentlyByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveRolePermanentlyByIdAuthorizationFilter(
