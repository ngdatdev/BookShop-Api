...
namespace BookShop.API.Controllers.Role.GetAllRolesTemporarilyRemoved.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllRolesTemporarilyRemoved authorization.
/// </summary>
public class GetAllRolesTemporarilyRemovedAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllRolesTemporarilyRemovedAuthorizationFilter(
