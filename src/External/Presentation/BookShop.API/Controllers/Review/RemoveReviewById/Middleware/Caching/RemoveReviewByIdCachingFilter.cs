...
namespace BookShop.API.Controllers.Review.RemoveReviewById.Middleware.Caching;

/// <summary>
///     Filter pipeline for RemoveReviewById caching.
/// </summary>
public class RemoveReviewByIdCachingFilter : IAsyncActionFilter
{
    private readonly ICacheHandler _cacheHandler;

    public RemoveReviewByIdCachingFilter(ICacheHandler cacheHandler)
    {
    ...
    )
    {
        if (!context.HttpContext.Response.HasStarted)
        {
            ...
            {
                var httpResponse = (RemoveReviewByIdHttpResponse)result.Value;
