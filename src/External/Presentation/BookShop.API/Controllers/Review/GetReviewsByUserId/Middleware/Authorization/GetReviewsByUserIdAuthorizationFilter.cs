...
namespace BookShop.API.Controllers.Review.GetReviewsByUserId.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetReviewsByUserId authorization.
/// </summary>
public class GetReviewsByUserIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetReviewsByUserIdAuthorizationFilter(
