...
namespace BookShop.API.Controllers.Order.RemoveOrderTemporarilyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveOrderTemporarilyById authorization.
/// </summary>
public class RemoveOrderTemporarilyByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveOrderTemporarilyByIdAuthorizationFilter(
