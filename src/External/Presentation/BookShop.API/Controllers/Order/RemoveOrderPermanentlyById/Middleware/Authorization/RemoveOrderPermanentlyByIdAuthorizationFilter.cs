...
namespace BookShop.API.Controllers.Order.RemoveOrderPermanentlyById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RemoveOrderPermanentlyById authorization.
/// </summary>
public class RemoveOrderPermanentlyByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RemoveOrderPermanentlyByIdAuthorizationFilter(
