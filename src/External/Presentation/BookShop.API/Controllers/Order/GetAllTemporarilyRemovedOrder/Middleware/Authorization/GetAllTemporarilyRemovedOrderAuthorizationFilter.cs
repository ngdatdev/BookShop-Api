...
namespace BookShop.API.Controllers.Order.GetAllTemporarilyRemovedOrder.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllTemporarilyRemovedOrder authorization.
/// </summary>
public class GetAllTemporarilyRemovedOrderAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllTemporarilyRemovedOrderAuthorizationFilter(
