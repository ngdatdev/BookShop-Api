...
namespace BookShop.API.Controllers.Order.GetAllOrders.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllOrders authorization.
/// </summary>
public class GetAllOrdersAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllOrdersAuthorizationFilter(
