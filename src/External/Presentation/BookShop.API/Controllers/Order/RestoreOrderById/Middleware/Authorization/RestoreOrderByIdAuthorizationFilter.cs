...
namespace BookShop.API.Controllers.Order.RestoreOrderById.Middleware.Authorization;

/// <summary>
///     Filter pipeline for RestoreOrderById authorization.
/// </summary>
public class RestoreOrderByIdAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public RestoreOrderByIdAuthorizationFilter(
