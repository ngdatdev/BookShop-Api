...
namespace BookShop.API.Controllers.Payments.GetAllPayments.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetAllPayments authorization.
/// </summary>
public class GetAllPaymentsAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetAllPaymentsAuthorizationFilter(
