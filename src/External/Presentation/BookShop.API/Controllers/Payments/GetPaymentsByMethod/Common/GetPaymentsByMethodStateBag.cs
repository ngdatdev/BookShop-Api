...
namespace BookShop.API.Controllers.Payments.GetPaymentsByMethod.Common;

/// <summary>
///     Represents the get GetPaymentsByMethod state bag.
/// </summary>
internal sealed class GetPaymentsByMethodStateBag
{
