...
namespace BookShop.API.Controllers.Payments.GetPaymentsByMethod.Middleware.Authorization;

/// <summary>
///     Filter pipeline for GetPaymentsByMethod authorization.
/// </summary>
public class GetPaymentsByMethodAuthorizationFilter : IAsyncAuthorizationFilter
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public GetPaymentsByMethodAuthorizationFilter(
