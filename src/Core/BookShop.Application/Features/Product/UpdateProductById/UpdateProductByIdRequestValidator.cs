...
/// <summary>
///    UpdateProductById Request Validator
/// </summary>
public sealed class UpdateProductByIdRequestValidator
    : FeatureRequestValidator<UpdateProductByIdRequest, UpdateProductByIdResponse>
{
    public UpdateProductByIdRequestValidator()
    {
